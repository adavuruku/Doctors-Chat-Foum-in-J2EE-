    ...
    <body style="background-image: url('res/medback.png');">
       <%@include file="headerLogin.jsp" %>
        <div class="row"style="margin-bottom:60px">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="background:beige; marging-bottom:15px;">
                ...
                <div class="col-xs-12">
                    <form role="form"  name="reg_form"  id="form" class="form-horizontal" action="./step2" method="POST">
                                <h4 style="margin-bottom:20px;background-color:#CCCCFF;padding:10px">Step (02/06) - Academic Qualification </h4> 
                        ...
                        <hr/>
                                ...
                                <div class="form-group">
                                    <label for="schoolname" class="control-label col-xs-3"> Institution Name <span style="color:red">*</span>: </label> 
                                    <div class="col-xs-9">
                                            <input type="text" class="form-control" id="certname" name="schoolname" value="<%= request.getAttribute("schoolname")%>" required="true" placeholder="Enter Name Of Institution"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="coursename" class="control-label col-xs-3"> Course / Programme <span style="color:red">*</span>: </label> 
                                    <div class="col-xs-9">
                                            <input type="text" class="form-control" id="coursename" name="coursename" value="<%= request.getAttribute("coursename")%>" required="true" placeholder="Enter Name Of Course"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                <label for="txtname" class="control-label col-xs-3"> Certificate Name <span style="color:red">*</span>: </label>
                                <div class="col-xs-9">
                                        <input type="text" class="form-control" id="certname" name="certname" value="<%= request.getAttribute("certname")%>" required="true" placeholder="Enter Name Of Certificate"/>
                                </div>
                                </div>
                                  <div class="form-group">
                                    <label for="type" class="control-label col-xs-3">Select Type <span style="color:red">*</span> : </label>
                                    <div class="col-xs-9">
                                        <select class="form-control js-example-basic-single" id="type" name="type" value="<%= request.getAttribute("type")%>">
                                 ...
                                 <div class="form-group" style="margin-top:25px">
                                    <label for="year" class="control-label col-xs-3">Date From : <span style="color:red">*</span> : </label>
                                    <div class="col-xs-9">
            ...
            <div class="col-xs-12" style="background-color: whitesmoke">
                    <%
                        ...
                        List<qualProf> results = (List<qualProf>)request.getAttribute("allreadySaved");
                            ...
                            <tbody>
                             ...
                             %>
                                ...
                                <tr>
                                    ...
                                    <td><a class="btn btn-primary" style="color:yellow;font-weight:bold;  text-decoration: none; padding:10px;" href="./removeAccad?bfid=<%=result.getId()%>">Delete</a></td>
