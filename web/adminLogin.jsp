...
<html>
       ...
       <link rel="stylesheet" type="text/css" href="res/bootstrap-theme.css"/>
        <link href="boot.css" rel="stylesheet" type="res/text/css" href="boot.css" media="screen"/>
       ...
       <%@include file="header.jsp" %>
        <div class="row" style="margin-bottom:60px">
            ...
            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5" style="background:beige">
                <form role="form"  name="reg_form"  id="form" class="form-vertical" action="./adminLogin" method="POST">
                            <h4 style="margin-bottom:20px;background-color:#CCFF33;padding:10px">Please Login - Platform Admin</h4>
                    <hr/>
                            <div class="form-group">
                                    <label for="txtreg">Admin ID : </label>
