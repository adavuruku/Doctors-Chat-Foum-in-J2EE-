       ...
       <%@include file="headerLogin.jsp" %>
        <div class="row"style="margin-bottom:60px">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="background:beige">
                ...
                <div class="col-xs-12">
                    <form role="form"  name="reg_form"  id="form" class="form-horizontal" action="./step3" method="POST">
                                <h4 style="margin-bottom:20px;background-color:#CCCCFF;padding:10px">Step (03/04) - Work Experience </h4>
                        ...
                        <hr/>
                                ...
                                <div class="form-group">
                                    <label for="schoolname" class="control-label col-xs-3"> Company Name <span style="color:red">*</span>: </label> 
                                    <div class="col-xs-9">
                                ...
                                <div class="form-group"> 
                                 <label for="contact" class="control-label col-xs-3">Position / Duty <span style="color:red">*</span> : </label>
                                 <div class="col-xs-9">
                                 ...
                                 <div class="form-group" style="margin-top:25px">
                                    <label for="year" class="control-label col-xs-3">Date Start : <span style="color:red">*</span> : </label>
                                    <div class="col-xs-9">
            ...
            <div class="col-xs-12" style="background-color: whitesmoke">
                    <%
                        ...
                        List<workArchieve> results = (List<workArchieve>)request.getAttribute("allreadyWorkers");
                            ...
                            <tbody>
                             ...
                             %>
                                ...
                                <tr>
                                    ...
                                    <td><a class="btn btn-primary" style="color:yellow;font-weight:bold;  text-decoration: none; padding:10px;" href="./removeWork?bfid=<%=result.getId()%>">Delete</a></td>
